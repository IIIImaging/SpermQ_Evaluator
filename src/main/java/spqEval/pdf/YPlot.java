...
public class YPlot extends PDFPlot {
	...
	static final String nameOfAveragePlot = "Y_average_plot.png";
	static final String nameOfRangePlot = "Y_range_plot.png";
	...
	public YPlot(int posX, int posY, int width, int height) {
		...
		desc = "upper panel: beat amplitude compared to head-midpiece axis, bottom panel: asymmetry compared to head-midpiece axis";
...
//		System.out.println("ranges : " + xMaxAv + "|" + xMinAv + "|" + yMaxAv + "|" + yMinAv);
	...
	private void getData() {
		...
		double [][] rawData = r.getFlagellarParameterResult("Y",(int)slicesPerCycle);
...
//		System.out.println("ranges : " + xMaxAv + "|" + xMinAv + "|" + yMaxAv + "|" + yMinAv);
	...
	private void addDescRange() {
		...
		PDFTools.insertTextBoxRotatedUpward(cts, x, rY0+rH/2, "range of y", pdt.subDescSize);
	...
	private void addDescAverage() {
		...
		PDFTools.insertTextBoxRotatedUpward(cts, x, aY0+aH/2, "average y", pdt.subDescSize);
